...
au FileType javascript set formatprg=prettier\ --stdin-filepath=file.js
" au FileType typescript set formatprg=prettier\ --stdin-filepath=file.ts
" au FileType typescriptreact set formatprg=prettier\ --stdin-filepath=file.tsx
...
au FileType xml set formatprg=prettier\ --stdin-filepath=file.xml
au FileType graphql set formatprg=prettier\ --stdin-filepath=file.graphql
